...
import { addEmp, removeEmp, resetAll, editEmp, closeEditEmp, saveEditEmp, adminResetSenha, fecharModalResetPwd, confirmarAdminResetSenha, abrirCriarAcesso, fecharCriarAcesso, confirmarCriarAcesso } from './config.js';
...
window.abrirCriarAcesso         = abrirCriarAcesso;
window.fecharCriarAcesso        = fecharCriarAcesso;
window.confirmarCriarAcesso     = confirmarCriarAcesso;
window.setV           = setV;
window.setSv          = setSv;
window.setAs          = setAs;
window.selU           = selU;
